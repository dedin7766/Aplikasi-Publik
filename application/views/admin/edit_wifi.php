...
<form action="<?php echo base_url().'admin/update_wifi' ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="nama_wifi" class="form-control" value="<?php echo $a->nama_wifi; ?>">
  </div>
   ...
   <div class="form-group">
    <label>Status</label>
    <input type="text" name="status" class="form-control" value="<?php echo $a->status; ?>">
  </div>
